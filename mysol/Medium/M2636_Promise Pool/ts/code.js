...
function promisePool(functions, n) {
    ...
    return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
        var results, inProgress, i, _loop_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i < functions.length || inProgress.length > 0)) return [3 /*break*/, 4];
                    _loop_1 = function () {
                    ...
                    if (!(inProgress.length > 0)) return [3 /*break*/, 3];
...
promisePool([function () { return sleep(500); }, function () { return sleep(400); }], 1)
    .then(function (item) {
    var output1 = item.length;
