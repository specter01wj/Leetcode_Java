...
public class Ch2_Minimum_Value_to_Get_Positive_Step_by_Step_Sum {

	public static void main(String[] args) {
		Ch2_Minimum_Value_to_Get_Positive_Step_by_Step_Sum solution = new Ch2_Minimum_Value_to_Get_Positive_Step_by_Step_Sum();
		int[] input = {-3,2,-3,4,2};
