package com.minimumNumberofMovestoSeatEveryone;
import java.util.*;
...
public class E2037_Minimum_Number_of_Moves_to_Seat_Everyone {

	public static void main(String[] args) {
		int[] input = {3,1,5}, students = {2,7,4};
		int output = minMovesToSeat(input, students);
        System.out.println("input: " + Arrays.toString(input) + "\noutput: " + (output));
	}
	
	/*
    solution:
    Sort both and sum the corresponding difference
    */
	
	/*
     * @param seats: a list of integers
