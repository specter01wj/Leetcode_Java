...
to eat the maximum number of different types of candies while 
...
Whether she eats types [1,2], [1,3], or [2,3], she still can 
...
public class E575_Distribute_Candies {
	...
	public static void main(String[] args) {
        ...
        int output = distributeCandies(input);
	...
	public static int distributeCandies(int[] candyType) {
		TreeSet<Integer> candyKinds = new TreeSet<Integer>();
		
        for(int candy: candyType) {
            candyKinds.add(candy);
        }
        
        return Math.min(candyKinds.size(), candyType.length / 2);
	}
