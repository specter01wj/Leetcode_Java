...
public class E292_Nim_Game {
	...
	public static void main(String[] args) {
		int input = 16;
        boolean output = canWinNim(input);
        System.out.println("input: " + (input) + "\noutput: " + (output));
	}
	
	/*
    solution:
    You can always win a Nim game if the number of stones nn in the pile is 
    not divisible by 44.
	...
	enough to leave four stones for your opponent so that they lose. 
    ...
    */
	...
	/*
     * @param n: an integer
     * @return: boolean, whether you can win the game given the number of stones in the heap
     */
