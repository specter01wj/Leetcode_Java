package com.maximumProductDifferenceBetweenTwoPairs;
import java.util.*;
...
public class E1913_Maximum_Product_Difference_Between_Two_Pairs {

	public static void main(String[] args) {
		int[] input = {5,6,2,7,4};
		int output = maxProductDifference(input);
