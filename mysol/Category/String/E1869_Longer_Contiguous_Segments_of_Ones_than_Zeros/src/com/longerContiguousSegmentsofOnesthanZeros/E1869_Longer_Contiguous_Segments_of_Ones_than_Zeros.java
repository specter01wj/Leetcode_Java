package com.longerContiguousSegmentsofOnesthanZeros;
import java.util.*;

/*
Given a binary string s, return true if the longest contiguous segment 
of 1's is strictly longer than the longest contiguous segment of 0's in s, 
...
public class E1869_Longer_Contiguous_Segments_of_Ones_than_Zeros {

	public static void main(String[] args) {
		String input = "110100010";
        boolean output = checkZeroOnes(input);
