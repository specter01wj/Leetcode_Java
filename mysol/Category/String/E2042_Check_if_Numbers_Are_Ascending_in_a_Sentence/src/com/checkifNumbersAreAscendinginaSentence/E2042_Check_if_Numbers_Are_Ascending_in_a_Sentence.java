package com.checkifNumbersAreAscendinginaSentence;
import java.util.*;
...
public class E2042_Check_if_Numbers_Are_Ascending_in_a_Sentence {

	public static void main(String[] args) {
		String input = "1 box has 3 blue 4 red 6 green and 12 yellow marbles";
        boolean output = areNumbersAscending(input);
